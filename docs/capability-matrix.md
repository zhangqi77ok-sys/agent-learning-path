...
> 前置：仓库 [Curriculum v2](../../agent-learning-path/docs/curriculum-foundations.md) 阶段 ①–④ **只算入门**。本矩阵是进阶主线。  
> 配套：[进阶课纲](/docs/curriculum.md) · [深挖题 v2](/docs/prep/interview-deep-dive.md) · [过不了就别去面](/docs/prep/interview-deep-dive.md#gate) · [进阶 JD 调研](/docs/prep/jd-research.md)
...
完整具名链接与交集见 **[进阶 JD 调研](/docs/prep/jd-research.md)**。此处只留矩阵用摘要。不写薪资均值、不写编制、不伪称「刷过 Boss」。仓库旧文 `docs/prep/jd-research-boss.md` 覆盖入门岗；**3–5 年岗已上移到 Runtime / Harness / 评测闭环 / 多租户 / 私有化**。
...
|----|------|-------------------|------------|----------|------|------|
| D1 | Runtime / Harness | 能分层控制面与执行面，而不是「一个图」 | 自研最小 Harness：Loop + Policy + Budget + Replay | 把框架当 Runtime | [A1](/docs/curriculum.md#a1) | [Q1](/docs/prep/interview-deep-dive.md#q1) |
| D2 | 耐久长任务 | Checkpoint / 队列 / 取消 / 补偿可恢复 | PG checkpoint + 取消传播 + 补偿记录 | MemorySaver 上生产 | [A2](/docs/curriculum.md#a2) | [Q4](/docs/prep/interview-deep-dive.md#q4) [Q6](/docs/prep/interview-deep-dive.md#q6) |
| D3 | 多租户安全 | 隔离键强制注入；RBAC + 审批 + 审计 | 跨租户读 0 行；审批写审计日志 | Prompt 里写「不要越权」 | [A3](/docs/curriculum.md#a3) | [Q2](/docs/prep/interview-deep-dive.md#q2) [Q3](/docs/prep/interview-deep-dive.md#q3) |
| D4 | 进阶 RAG | 混合检索 + 重排 + 版本/过期 + 检索 ACL | 租户过滤 + 过期文档不进上下文 | 检索后再用 Prompt 过滤 | [A4](/docs/curriculum.md#a4) | [Q7](/docs/prep/interview-deep-dive.md#q7) |
| D5 | MCP / A2A / 注册中心 / 沙箱 | 协议 + 治理，不是起一个 MCP server | Registry、schema 版本、沙箱策略 | 工具直连生产库 | [A5](/docs/curriculum.md#a5) | [Q3](/docs/prep/interview-deep-dive.md#q3) [Q8](/docs/prep/interview-deep-dive.md#q8) |
| D6 | Eval / 观测 / 门禁 | 四层评测 + OTEL + 发布红线 | Trace→Bad Case→回归必跑 | 只有 LLM-as-Judge 总分 | [A6](/docs/curriculum.md#a6) | [Q12](/docs/prep/interview-deep-dive.md#q12)–[Q14](/docs/prep/interview-deep-dive.md#q14) |
| D7 | 模型网关 / 成本 | 按租户路由、预算、429 降级 | 路由决策进 Trace；超预算可拒绝 | 全局一个模型硬编码 | [A7](/docs/curriculum.md#a7) | [Q9](/docs/prep/interview-deep-dive.md#q9) [Q10](/docs/prep/interview-deep-dive.md#q10) |
| D8 | 分布式高并发 | 队列、无状态 Runtime、隔离与背压 | 压测下 P95 与取消仍正确 | 进程内线程池当平台 | [A8](/docs/curriculum.md#a8) | [Q6](/docs/prep/interview-deep-dive.md#q6) [Q11](/docs/prep/interview-deep-dive.md#q11) |
| D9 | Java 网关 → Python Agent 身份 | 可信身份单向注入，Agent 不可抬权 | 伪造 header 被拒；工具带下行身份 | Agent 自己解析用户 JWT | [A3](/docs/curriculum.md#a3) [A5](/docs/curriculum.md#a5) | 口述题 G7 |
| D10 | 系统设计 | 20 分钟画得完、说得清 SPOF 与一个 SLO | 组件图 + 故障域 + 门禁 | 只画 Agent 节点 | [A9](/docs/curriculum.md#a9) | [Q15](/docs/prep/interview-deep-dive.md#q15) |
...
**链接**：模块 [A1](/docs/curriculum.md#a1) · 题 [Q1](/docs/prep/interview-deep-dive.md#q1)
...
**链接**：模块 [A2](/docs/curriculum.md#a2) · 题 [Q4](/docs/prep/interview-deep-dive.md#q4) [Q5](/docs/prep/interview-deep-dive.md#q5) [Q6](/docs/prep/interview-deep-dive.md#q6)
...
- 四个隔离键（见 [Q2](/docs/prep/interview-deep-dive.md#q2)）是主键，不是日志字段。模型、检索 query、工具参数**都不能改 tenant_id**。
...
**链接**：模块 [A3](/docs/curriculum.md#a3) · 题 [Q2](/docs/prep/interview-deep-dive.md#q2) [Q3](/docs/prep/interview-deep-dive.md#q3)
...
**链接**：模块 [A4](/docs/curriculum.md#a4) · 题 [Q7](/docs/prep/interview-deep-dive.md#q7)
...
**链接**：模块 [A5](/docs/curriculum.md#a5) · 题 [Q3](/docs/prep/interview-deep-dive.md#q3) [Q8](/docs/prep/interview-deep-dive.md#q8) · 口述 [G2](/docs/curriculum.md#oral)
...
四层评测与瓴知等公开 JD 对齐，三份文档必须用同一套名字（Model / Framework / Harness / Application）。另有面试常用切片：**结果 / 轨迹 / 成本 / 对抗**——与主口径对照见 [Q12](/docs/prep/interview-deep-dive.md#q12)，两套都要能讲。
...
- 线上失败必须能**快照脱敏后重放**，并进入回归集（[Q14](/docs/prep/interview-deep-dive.md#q14)）。

**可演示产物**：四层报告 + 一条红线配置；故意坏工具被 Harness 层拦住且 Application 层记失败原因，而不是「模型不行」。

**挂科模式**：20 条固定题调到 95 分；Trace 只有 printf。

**链接**：模块 [A6](/docs/curriculum.md#a6) · 题 [Q12](/docs/prep/interview-deep-dive.md#q12)–[Q14](/docs/prep/interview-deep-dive.md#q14) · 口述 [G4](/docs/curriculum.md#oral)
...
**链接**：模块 [A7](/docs/curriculum.md#a7) · 题 [Q9](/docs/prep/interview-deep-dive.md#q9) [Q10](/docs/prep/interview-deep-dive.md#q10)
...
**链接**：模块 [A8](/docs/curriculum.md#a8) · 题 [Q11](/docs/prep/interview-deep-dive.md#q11) [Q15](/docs/prep/interview-deep-dive.md#q15)
...
**链接**：模块 [A3](/docs/curriculum.md#a3) [A5](/docs/curriculum.md#a5) · 口述 [G7](/docs/curriculum.md#oral)
...
**期望深度**：每道口述题必须同时给出 **组件图、一个 SPOF、一个定量 SLO**（课程建议值，不是行业统计）。见 [课纲口述题](/docs/curriculum.md#oral) 与 [Q15](/docs/prep/interview-deep-dive.md#q15)。
...
阶段 ⑤⑥ 与作品集不再按 v2 入门口径验收，统一收到 [进阶课纲](/docs/curriculum.md)。

---

## 作品集与口试硬门槛

- Capstone 五段演示见 [A9](/docs/curriculum.md#capstone)（隔离键 / Outbox / 检索 ACL / 预算熔断 / Trace→Eval）。
- 课堂 Demo 的 [10 个死亡坑](/docs/curriculum.md#holes) 必须能逐条反驳。
- 面试前过 [过不了就别去面](/docs/prep/interview-deep-dive.md#gate)；O10 事故叙事必过。

---

## 转岗建议（给 Java 四年经验）

你的可迁移资产：网关鉴权、幂等、Outbox、分布式锁、熔断、RBAC、审计。缺口通常在：**Harness 分层、检索 ACL、Eval 门禁、上下文工程**。作品集优先做 [A9 Capstone 五段演示](/docs/curriculum.md#capstone)，不要再堆第三个 Chatbot。
