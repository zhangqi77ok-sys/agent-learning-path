...
> 题库底稿：[interview-deep-dive-v2.md](../interview-deep-dive-v2.md) · 必追问：[deep-dive-must-ask.md](../deep-dive-must-ask.md)

## 流程

1. **出题人**：深挖侧 @Agent工程师；架构/Java 侧 @Java高级架构师；学生作答并引用仓库路径。
2. **每场文档**固定结构；答完由出题人在文末写「评分 / 补洞」。
3. **合入**后更新 [team-decisions-and-status.md](../team-decisions-and-status.md)。
