...
> **前置**：仓库 Curriculum v2 阶段 ①–④（`02-applications/01-api-serving` … `stage-04`）只算入门。会调 API、会写 Loop、会 RAG 引用、会 LangGraph + `MemorySaver` + `interrupt`，**不够投 3–5 年岗**。  
> 配套：[能力矩阵](/docs/capability-matrix.md) · [深挖题 v2（15 题）](/docs/prep/interview-deep-dive.md) · [过不了就别去面（10 口试）](/docs/prep/interview-deep-dive.md#gate) · [进阶 JD 调研](/docs/prep/jd-research.md)
...
公开猎聘向 JD 的交集（具名来源见 [JD 调研](/docs/prep/jd-research.md)）：
...
| # | 死亡坑 | 课堂现状 | 3–5 年必须补到 |
|---|--------|----------|----------------|
| 1 | Checkpoint ≠ 业务一致性 | 状态回写成功就当「做完了」 | 外部写走 [执行账本 / Outbox](/docs/prep/interview-deep-dive.md#q5)；工具成功但 checkpoint 失败见 [口试 O1](/docs/prep/interview-deep-dive.md#o1) |
| 2 | 无 Worker 租约 | 单进程内存图 | 单 `run_id` 互斥租约；双 Worker 不能双跑 |
| 3 | HITL 无审批人身份 / 过期 | `resume={'approved': True}` | 审批人、过期、快照哈希、拒绝审计 |
| 4 | 租户只在 State 里 | 模型可写的字段当隔离 | 四键由网关注入，RLS 强制，见 [Q2](/docs/prep/interview-deep-dive.md#q2) |
| 5 | MCP 无工具投毒防御 | 信任 `list_tools` 描述 | 白名单、schema 指纹、钉版本，见 [O5](/docs/prep/interview-deep-dive.md#o5) |
| 6 | RAG 无 ACL / 版本 | 单库 TF-IDF + 引用 | 检索前 ACL、过期/版本、历史可复现，见 [O4](/docs/prep/interview-deep-dive.md#o4) [O7](/docs/prep/interview-deep-dive.md#o7) |
| 7 | 无 Eval 门禁 | 无黄金集版本、无 holdout | 四层 Eval + 硬门禁，见 [Q12](/docs/prep/interview-deep-dive.md#q12) [O8](/docs/prep/interview-deep-dive.md#o8) |
| 8 | 无成本 / P99 | 只看「能跑通」 | 租户预算、P95/P99、429 降级 |
| 9 | 无 Spring 集成 | Python 单飞 | Java 网关身份、MQ/SSE、事务归属，见 [O9](/docs/prep/interview-deep-dive.md#o9) [G7](#g7) |
| 10 | 作品集无法证明生产 | 无事故、无 Trace 闭环、无负例 | Capstone 五段 + 一篇结构化事故（[O10](/docs/prep/interview-deep-dive.md#o10)） |
...
建议实现目录（尚未建，评审后再进仓库）：`03-modules/A1-…`。

| ID | 模块 | 主要深挖 | 口试 / 口述 |
|----|------|----------|-------------|
| A1 | Runtime 控制面 | [Q1](/docs/prep/interview-deep-dive.md#q1) [Q11](/docs/prep/interview-deep-dive.md#q11) | [O6](/docs/prep/interview-deep-dive.md#o6) |
| A2 | 长任务一致性 | [Q4](/docs/prep/interview-deep-dive.md#q4) [Q5](/docs/prep/interview-deep-dive.md#q5) [Q6](/docs/prep/interview-deep-dive.md#q6) | [O1](/docs/prep/interview-deep-dive.md#o1) [O2](/docs/prep/interview-deep-dive.md#o2) [O3](/docs/prep/interview-deep-dive.md#o3) |
| A3 | 企业租户 / RBAC / 审批 / 审计 | [Q2](/docs/prep/interview-deep-dive.md#q2) [Q8](/docs/prep/interview-deep-dive.md#q8) | [G3](#g3) [G7](#g7) |
| A4 | 进阶 RAG：混合 / 重排 / 版本过期 | [Q7](/docs/prep/interview-deep-dive.md#q7) | [O4](/docs/prep/interview-deep-dive.md#o4) [O7](/docs/prep/interview-deep-dive.md#o7) |
| A5 | MCP / A2A + Registry / 沙箱 | [Q3](/docs/prep/interview-deep-dive.md#q3) [Q8](/docs/prep/interview-deep-dive.md#q8) | [O5](/docs/prep/interview-deep-dive.md#o5) [G2](#g2) |
| A6 | 四层 Eval + OTEL + 门禁 | [Q12](/docs/prep/interview-deep-dive.md#q12)–[Q14](/docs/prep/interview-deep-dive.md#q14) | [O8](/docs/prep/interview-deep-dive.md#o8) [G4](#g4) |
| A7 | 模型网关 / 路由 / 成本 | [Q9](/docs/prep/interview-deep-dive.md#q9) [Q10](/docs/prep/interview-deep-dive.md#q10) | [G5](#g5) |
| A8 | 高可用 / 分布式 Agent 平台 | [Q6](/docs/prep/interview-deep-dive.md#q6) [Q11](/docs/prep/interview-deep-dive.md#q11) | [O9](/docs/prep/interview-deep-dive.md#o9) |
| A9 | Capstone：多租户企业 Agent 控制面 | [Q15](/docs/prep/interview-deep-dive.md#q15) | [G1](#g1) [O10](/docs/prep/interview-deep-dive.md#o10) |
...
**面试映射**：[D1](/docs/capability-matrix.md#d1) · [Q1](/docs/prep/interview-deep-dive.md#q1) [Q11](/docs/prep/interview-deep-dive.md#q11)
...
**故障注入**：tool 成功后杀进程再写 checkpoint（[O1](/docs/prep/interview-deep-dive.md#o1)）；双 Worker 抢 run；取消发生在 HTTP 进行中。

**指标 / SLO**：重复 resume 外部 mock = 1；取消后 5s 内无新 tool；kill -9 后 30s 内可 resume。

**面试映射**：[D2](/docs/capability-matrix.md#d2) · [Q4](/docs/prep/interview-deep-dive.md#q4)–[Q6](/docs/prep/interview-deep-dive.md#q6) · [O1](/docs/prep/interview-deep-dive.md#o1)–[O3](/docs/prep/interview-deep-dive.md#o3)
...
**面试映射**：[D3](/docs/capability-matrix.md#d3) [D9](/docs/capability-matrix.md#d9) · [Q2](/docs/prep/interview-deep-dive.md#q2) [Q8](/docs/prep/interview-deep-dive.md#q8) · [G7](#g7)
...
**面试映射**：[D4](/docs/capability-matrix.md#d4) · [Q7](/docs/prep/interview-deep-dive.md#q7) · [O4](/docs/prep/interview-deep-dive.md#o4) [O7](/docs/prep/interview-deep-dive.md#o7)
...
**面试映射**：[D5](/docs/capability-matrix.md#d5) · [Q3](/docs/prep/interview-deep-dive.md#q3) · [O5](/docs/prep/interview-deep-dive.md#o5) · [G2](#g2)
...
- 四层：Model / Framework / Harness / Application（与矩阵 [D6](/docs/capability-matrix.md#d6) 同名）。面试若被问「结果/轨迹/成本/对抗」，按 [Q12 对照表](/docs/prep/interview-deep-dive.md#q12) 映射，不要否认另一套切片。
...
**面试映射**：[D6](/docs/capability-matrix.md#d6) · [Q12](/docs/prep/interview-deep-dive.md#q12)–[Q14](/docs/prep/interview-deep-dive.md#q14) · [O6](/docs/prep/interview-deep-dive.md#o6) [O8](/docs/prep/interview-deep-dive.md#o8) · [G4](#g4)
...
**面试映射**：[D7](/docs/capability-matrix.md#d7) · [Q9](/docs/prep/interview-deep-dive.md#q9) [Q10](/docs/prep/interview-deep-dive.md#q10) · [G5](#g5)
...
**面试映射**：[D8](/docs/capability-matrix.md#d8) · [O9](/docs/prep/interview-deep-dive.md#o9) · [G1](#g1)
...
**硬概念**：见 [Q15](/docs/prep/interview-deep-dive.md#q15)。能讲清 10 个死亡坑各补了哪一块。
...
**面试映射**：全部 Q + [O10](/docs/prep/interview-deep-dive.md#o10) + 下方 7 道口述。
...
- **映射**：[Q15](/docs/prep/interview-deep-dive.md#q15) · A9
...
- **映射**：A5 · [O5](/docs/prep/interview-deep-dive.md#o5)
...
- **映射**：A2 · [Q5](/docs/prep/interview-deep-dive.md#q5) · [O3](/docs/prep/interview-deep-dive.md#o3)
...
- **映射**：A6 · [O8](/docs/prep/interview-deep-dive.md#o8)
