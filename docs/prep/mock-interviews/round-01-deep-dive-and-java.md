...
| 关联课纲 | A2/A3/A4/A5/A6/A9 · B1/B2 · `docs/prep/interview-deep-dive.md` |
...
- `03-modules/A2-long-task/`（O1 故障注入）
- `03-modules/A9-capstone/` 段 (b)
- `04-frontier/B1-durable-runtime/`（重复 Signal → `create_calls==1`）
...
- `03-modules/A4-advanced-rag/`（跨租户 hit=0、版本 pin）
- `03-modules/A3-tenant-auth/kb.py`
- Capstone 段 (c)：`03-modules/A9-capstone/`
...
**证据路径**：`03-modules/A5-mcp-registry/` · Capstone HOLES #5
...
**证据路径**：`03-modules/A6-eval-otel/` · A9 段 (e)
...
**证据路径**：`03-modules/A3-tenant-auth/` · A9 `identity.py` · B1 `OWNERSHIP.md`
...
**证据路径**：`docs/durable-runtime-research.md` §2 · `B1-durable-runtime/OWNERSHIP.md` · B1 demo4 超管 bypass
