...
**证据**：`03-modules/A1-runtime/` · B1 OWNERSHIP（编排 vs 领域）
...
**证据**：`03-modules/A6-eval-otel/` · A9 (e)
...
**证据**：`03-modules/A9-capstone/` demo 段 (a) · `control_plane/identity.py` · `tests/test_negatives.py`
