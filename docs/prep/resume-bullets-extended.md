...
> 在 [/docs/prep/resume-differentials.md](/docs/prep/resume-differentials.md) 三条差异化之外，再备 **至少 10 条**可剪贴条目。  
...
- **证据**：`03-modules/A2-long-task/` · Mock R1 O1  
...
- **证据**：A2 lease · `03-modules/A8-ha-platform/` demo1  
- **JD 关键词**：分布式、租约、队列
...
- **证据**：`03-modules/A3-tenant-auth/` · Capstone HITL  
- **JD 关键词**：RBAC、HITL、审计  
- **与①呼应**：四键不来自模型。
...
- **证据**：`03-modules/A4-advanced-rag/` · O4/O7  
- **JD 关键词**：RAG、多租户、合规引用
...
- **证据**：`03-modules/A5-mcp-registry/` · O5  
...
- **证据**：`03-modules/A6-eval-otel/` · O8 · R2 Q12  
- **JD 关键词**：评测、门禁、可观测
...
- **证据**：`03-modules/A7-model-gateway/`  
...
- **证据**：`03-modules/A8-ha-platform/` · `DEPLOY.md` · G1  
...
- **证据**：`04-frontier/B2-a2a/` · `DESIGN.md`  
...
- **证据**：`04-frontier/B1-durable-runtime/` · 调研稿 `docs/durable-runtime-research.md`  
...
Capstone 路径：`03-modules/A9-capstone/` · `HOLES.md` 十条对照。
